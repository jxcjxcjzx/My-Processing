...
public class SRRunner {
	...
	public static final String SPEAKRIGHT_VERSION = "0.1.4";
	...
	{
		m_run.setExtensionFactory(factory);
	}
	...
	/**
	 * Get the locations object, which holds
	 * directory and paths used by SpeakRight,
	 * such as the 'project dir'.
	 * @return
	 */
	public SRLocations locations()
	{
		return m_run.locations();
	}
	...
	{
		m_run.setModelBinder(model, binder);
	}
	public void restoreModelBinder(IModelBinder binder)
	{
		m_run.restoreModelBinder(binder);
	}
	
	public void setContentLogging(String dir)
	{
		m_run.setContentLogging(dir);
	}
