...
public class MGen {
	...
	public static void main(String[] args) {
		...
		String xmlPath = InteractiveTester.dir + "model.xml";
		String code = gen.run("org.speakright.demos.simpsons", xmlPath);
		
		String path = InteractiveTester.dir;
		path = path.replace("\\testfiles\\", "\\");
		path = path.replace("\\tests\\", "\\");
		path += "Model.java";
