...
public class ReadBox extends PApplet {
...
public void handle_in_mousePressed()
{
  jishu=mouseY/20;
...
public void handle_in_keyPressed()
{
  if (keyCode==17) {
    firstpass = true;
  }
...
class paster
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "ReadBox" };
    if (passedArgs != null) {
